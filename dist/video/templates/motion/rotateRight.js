"use strict";
// src/video/templates/motion/rotateRight.ts
Object.defineProperty(exports, "__esModule", { value: true });
exports.rotateRightTemplate = void 0;
const child_process_1 = require("child_process");
const easing_1 = require("./easing");
exports.rotateRightTemplate = {
    id: "rotateRight",
    label: "Rotate Right",
    description: "Gentle rightward rotation (clockwise).",
    async render({ imagePath, outputPath, options }) {
        ...
        await new Promise((resolve, reject) => {
            ...
            ff.stderr.on("data", (d) => console.log("[rotateRight]", d.toString()));
            ff.on("close", (code) => code === 0 ? resolve() : reject(new Error("rotateRight failed")));
        });
    },
};
