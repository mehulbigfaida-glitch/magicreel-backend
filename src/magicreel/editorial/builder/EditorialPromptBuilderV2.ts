...
Its visual identity is defined by ${world.dna.architecture.join(", ")}, complemented by ${world.dna.environment.join(", ")}, illuminated through ${world.dna.lighting.join(", ")}, enriched with ${world.dna.colors.join(", ")}, shaped by ${world.dna.weather.join(", ")}, and elevated by ${world.dna.atmosphere.join(", ")}.

Every photograph should naturally embody the mood of ${world.dna.mood.join(", ")} while maintaining complete visual consistency throughout the campaign.
