...
type HeroIntentInput = {
  avatarGender: "male" | "female";
  garmentType: string; // e.g. "top", "shirt", "ethnic_set"
};

export function resolveHeroCategoryKey(
  input: HeroIntentInput
): string {
  ...
  throw new Error(
    `Unsupported hero category: gender=${avatarGender}, garmentType=${garmentType}`
  );
}
