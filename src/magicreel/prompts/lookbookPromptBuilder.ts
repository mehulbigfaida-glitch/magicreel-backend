type LookbookPoseType =
  ...
  | "back"
  | "zoomed_back"
  | string; // category fallbacks

interface LookbookPromptInput {
  poseType: LookbookPoseType;
  scenePrompt: string; // already resolved scene description
}
