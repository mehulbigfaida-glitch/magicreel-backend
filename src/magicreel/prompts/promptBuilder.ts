...
export function buildP2MPrompt({
  ...
  const scenePrompt = PROMPT_REGISTRY_V1[category];
  ...
  const garmentFidelityLock =
    "Preserve the exact garment structure, fabric texture, stitching details, sleeve length, neckline shape and overall fit exactly as shown in the input garment image.";
